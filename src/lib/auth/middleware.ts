import { getCoupleForUser, getUser } from "@/src/lib/db/queries";
import type { CoupleDataWithMembers, User } from "@/src/lib/db/schema";
...
type ActionWithCoupleFunction<T> = (
	formData: FormData,
	couple: CoupleDataWithMembers,
) => Promise<T>;
