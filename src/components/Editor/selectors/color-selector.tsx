	...
	return (
		<Popover modal={true} open={open} onOpenChange={onOpenChange}>
			<PopoverTrigger asChild>
				<Button
					variant="ghost"
					className="gap-2 rounded-none border-none hover:bg-accent dark:hover:bg-zinc-700"
					type="button"
				>
					<span
				...
				<div className="flex flex-col">
					...
					{TEXT_COLORS.map(({ name, color }, index) => (
						<EditorBubbleItem
							...
							className="flex cursor-pointer items-center justify-between px-2 py-1 text-sm hover:bg-accent dark:hover:bg-zinc-700"
						>
