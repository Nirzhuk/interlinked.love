...
export default function GeneralPage() {
	...
	return (
		<section className="flex-1 p-4 lg:p-8">
			<h1 className="text-lg lg:text-2xl font-medium dark:text-white text-gray-900 mb-6">General Settings</h1>
			...
			<Card className="dark:bg-zinc-900">
				...
				<CardContent>
					<form className="space-y-4" onSubmit={handleSubmit}>
						...
						<Button type="submit" className="bg-violet-500 hover:bg-violet-600 text-white" disabled={isPending}>
							{isPending ? (
								<>
			...
			<Card className="mt-8 mb-8 dark:bg-zinc-900">
				<CardHeader>
				...
				<CardContent>
					<form className="space-y-4" onSubmit={handlePasswordSubmit}>
						...
						<Button type="submit" className="bg-violet-500 hover:bg-violet-600 text-white" disabled={isPasswordPending}>
							{isPasswordPending ? (
								<>
									<Loader2 className="mr-2 h-4 w-4 animate-spin" />
									Updating...
